...
//  iNoteCore
//
//  Created by xuxiaomin on 16/7/30.
...
class HelpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let hView = HelpView()
        hView.frame = CGRectMake(10, 150, self.view.bounds.width - 20, self.view.bounds.height - 20)
...
class HelpView: UIView{
    ...
    override func drawRect(rect: CGRect) {
        ...
        attachment.image = UIImage(named: "record.jpg")
        let attributedStr = NSAttributedString(attachment: attachment)
        // NSAttachmentAttributeName
        mutableAttrStr.insertAttributedString(attributedStr, atIndex: 60)
        // ----------结束
